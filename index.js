...
console.log(createMenuItem("Doner", 11, "Sandwich"));
...
*/
console.log(createMenuItem("taco", 9, "lunch"));
console.log(createMenuItem("kabab", 12, "dinner"));
console.log(createMenuItem("kunafa", 7, "dessert"));

let newMenu = [];
newMenu.push(createMenuItem("kufta", 11, "lunch"));
newMenu.push(createMenuItem("pizza", 6, "lunch"));
newMenu.push(createMenuItem("sandwich", 7, "dinner"));
console.log(newMenu);
